...
public class LadderRental extends ToolRental{
    ...
    ArrayList<String> codeList 	= new ArrayList<String>() {{ add("LADW"); }};
    ArrayList<String> brandList = new ArrayList<String>() {{ add("Werner"); }};
    
	
	private final double 	dailyCharge		= 1.99;

	private final boolean 	chargeWeekday 	= true;
	private final boolean 	chargeWeekend 	= true;
	private final boolean 	chargeHoliday 	= false;
	
	private final String 	entity		= "Ladder";
	
	
	// Create a Ladder Rental Item


	public LadderRental(String code, String brand ) throws Exception {
